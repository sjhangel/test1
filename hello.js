...
function(n) {
    ...
    function t() {
        function n(a, u) {
            if (!o[a] && !l(a, N)) {
                o[a] = 1,
                l(a, L) || r[a] || (r[a] = 1, e.push(a));
                var f = T[a];
                f ? u && (r[a] || (r[a] = 1, e.push(a)), $(f.depMs,
                function(e) {
                    n(e.absId, e.hard)
                })) : i[a] || (i[a] = 1, t.push(a))
            }
    ...
    function w(n) {
        function e(e, r) {
            if ("string" == typeof e) return t[e] || (t[e] = m(q(e, n))),
            t[e];
    ...
    function S() {
        ...
        for (var n = document.getElementsByTagName("script"), e = n.length; e--;) {
            var t = n[e];
            if ("interactive" === t.readyState) return Z = t,
            t
        }
    }
    function U(n) {
    ...
    e.config = function(n) {
        if (n) {
            for (var e in C) {
                var t = n[e],
                r = C[e];
                if (t) if ("urlArgs" === e && "string" == typeof t) C.urlArgs["*"] = t;
